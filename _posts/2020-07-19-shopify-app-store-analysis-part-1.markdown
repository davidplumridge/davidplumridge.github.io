---
layout: post
title:  "Shopify app store analysis (part 1)"
...
Now, before I go any further I just want to clarify this is not a research paper! I've spent a few hours each weekend for the last few weeks working on this.

Of course, if you have any questions or suggestions then you can contact me [here](/contact).
...
1. It's not possible to know exactly how many installs / customers each app has. Popularity can only be determined by the number (and quality) of customer reviews
2. Apps are sometimes listed in 2 categories. Where relevant I have included some comments on how this has been handled
3. I've interpreted positive reviews as being 4 stars or more and negative reviews as being 3 stars or less
...
Do you want some extra data or have a suggestion?
